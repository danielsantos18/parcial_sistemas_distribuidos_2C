...
public class CardTransactionSaveLambda implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        try {
            ...
            TransactionResponse resp = transactionService.deposit(body);
